...
//fare prima le get che le set x tutti 
       ...
       public function getNome() {  //x estrarre dati dall'oggetto
           return $nome;    //posso anche togliere il this e lasciare $nome: non ci sono dubbi su cosa sia nome, l'unico nome che conosce è l'attributo dell'ogg utente perchè è dichiarato nella mia classe
       }
